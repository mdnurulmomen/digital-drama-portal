...
<html lang="en">
	...
	<body>
		...
		if (ISSET($_REQUEST["dramaExpectedPartId"])){
			...
			$parsed_Query = vedioDramaAllParts($selectedDramaID);
		...
		?> 	
			...
			?>
				<div class="col col-sm-3 col-xs-3 text-center">
					<a href="vedioDrama.php?dramaType=<?php echo base64_encode($selectedDramaType); ?>&dramaID=<?php echo base64_encode($selectedDramaID); ?>&dramaExpectedPartId=<?php echo base64_encode($dramaPartId[$i]);?>">
		...
		$parsed_Query = vedioDramaOtherDrama($selectedDramaType, $selectedDramaID);
		...
		?>
			...
			<div class="row jumbotron">
				...
				<?php for($i = 0; $i<count($otherDramaId); $i++){ ?>
					<div class="col col-sm-3 col-xs-3 text-center ">
						<a href="vedioDrama.php?dramaType=<?php echo base64_encode($selectedDramaType);?>&dramaID=<?php echo base64_encode($otherDramaId[$i]);?>">
		...
		<ul class="pager more">
			<li class="next"><a href="more.php?dramaType=<?php echo base64_encode($selectedDramaType); ?>">more <i class="fa fa-angle-double-right"></i></a></li>
		</ul>
